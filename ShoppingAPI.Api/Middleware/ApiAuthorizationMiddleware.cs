...
namespace ShoppingAPI.Api.Middleware
{
    ...
    public class ApiAuthorizationMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext httpContext)
        {
            ...
            if (httpContext.Request.Path != null && !_jwtExceptUrlList.CurrentValue.URLList.Contains(httpContext.Request.Path.Value) && httpContext.Request.Path != "/User/Anasayfa" && httpContext.Request.Path != "/User/Register")
            {
